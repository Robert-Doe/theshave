...
class AptmntPage extends StatefulWidget {
  const AptmntPage({Key? key}) : super(key: key);

  @override
  State<AptmntPage> createState() => AptmntPageState();
}

class AptmntPageState extends State<AptmntPage> {
  ...
  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Thank you for booking.Please be on time"),
   duration: const Duration(milliseconds: 1500),));
            ...
            },label: Text("Book "),icon: Icon(Icons.cut), )
          ],
        ),
          ...
          children: [
            ClipRRect(
                ...
                child: Image.network("https://images.pexels.com/photos/2076930/pexels-photo-2076930.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
                  fit: BoxFit.cover,height: 160,width: 300,)),
        ...
        children: [
          ...
          Padding(
            ...
            child: ListTile(title: Text("Hair Cut",style:stylesub ,),
              subtitle: ElevatedButton(onPressed: (){}, child: Text("See gallery",style: stylehead,),
          ...
          Padding(
            ...
            child:ListTile(title: Text("Hair Coloring",style:stylesub ,),
              ...
              Text("See gallery",style: stylehead,),style: ElevatedButton.styleFrom(
                  shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(20)
                  ),
                  shadowColor: Colors.pink[100],
  ...
  return Padding(
    ...
    child: Card(
      ...
      child: ListView(
        shrinkWrap: true,
        children: [
          Text("Appointments 0",style: stylehead,),
          SizedBox(
            height: 10,
          ),
